...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_t_global",     type=int,   default=4)
    parser.add_argument("--n_t_local",      type=int,   default=4)
    ...
    parser.add_argument("--evaluation_samples", type=int, default=1000)
